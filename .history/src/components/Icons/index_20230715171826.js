...
export const HeartIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    ...
    >
        <g fillRule="evenodd" clipRule="evenodd" fill="currentColor">
            ...
            <path d="M2.402 12.2c1.187 2.497 3.357 4.727 5.348 6.55C9.55 20.399 11 21.5 12 21.5s2.41-1.093 4.25-2.75c2.98-2.684 6.25-6.25 6.25-10.25 0-.087-.002-.174-.005-.26C20.567 13.661 13.68 18.5 11.75 18.5c-1.437 0-6.14-2.687-9.348-6.3Z"></path>
        </g>
    </svg>
);
